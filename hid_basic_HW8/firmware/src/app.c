...
//                            }
                            ...
                            for (i=0;i<25;i++)
                            {
                                input[i] = appData.receiveDataBuffer[i+1];
                            }
                            
                            start_position[0] = (appData.receiveDataBuffer[26]-48)*5;
                            start_position[1] = 1;
                            ...
                            while(input[i])
                            {
                                ...
                                appData.transmitDataBuffer[1] = xg1;
                                appData.transmitDataBuffer[2] = xg2;
                                appData.transmitDataBuffer[3] = yg1;
                                appData.transmitDataBuffer[4] = yg2;
                                appData.transmitDataBuffer[5] = zg1;
                                appData.transmitDataBuffer[6] = zg2;
